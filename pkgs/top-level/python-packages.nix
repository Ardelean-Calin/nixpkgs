...
with self; {
  ...
  jaxlib =
    if jaxlib-build.meta.unsupported
    then jaxlib-bin
    else jaxlib-build;
  ...
  libiio =
    (toPythonModule (pkgs.libiio.override {
      pythonSupport = true;
      inherit python;
    }))
    .python;
  ...
  lief =
    (toPythonModule (pkgs.lief.override {
      inherit python;
    }))
    .py;
  ...
  mininet-python =
    (toPythonModule (pkgs.mininet.override {
      python3 = python;
    }))
    .py;
  ...
  */
  ...
  z3-solver =
    (toPythonModule ((pkgs.z3.override {
        inherit python;
      })
      .overrideAttrs (_: {
        pname = "z3-solver";
  ...
  zeek =
    (toPythonModule (pkgs.zeek.broker.override {
      python3 = python;
    }))
    .py;
  ...
  zeitgeist =
    (toPythonModule (pkgs.zeitgeist.override {
      python3 = python;
    }))
    .py;
